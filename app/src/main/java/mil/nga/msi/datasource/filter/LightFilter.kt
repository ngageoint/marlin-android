...
class LightFilter {
   companion object {
      val parameters = listOf(
         ...
         FilterParameter(title = "Characteristic Number", parameter = "characteristic_number", type = FilterParameterType.INT),
         FilterParameter(title = "Signal", parameter = "characteristic", type = FilterParameterType.STRING),
         ...
         FilterParameter(title = "Subregion Heading", parameter = "subregion_heading", type = FilterParameterType.STRING),
         FilterParameter(title = "Local Heading", parameter = "local_heading", type = FilterParameterType.STRING),
         ...
         FilterParameter(title = "Region", parameter = "section_header", type = FilterParameterType.STRING)
      )
   }
}